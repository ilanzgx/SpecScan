...
<template>
  <div class="p-4 space-y-6">
    ...
    <div v-if="physicalDisks && physicalDisks.length > 0">
      <h3 class="text-xl font-bold mb-2">Drives Físicos</h3>
      <div v-for="disk in physicalDisks" :key="disk.serial_number" class="mb-4">
        <ul class="space-y-1">
    ...
    <div v-if="disks && disks.length > 0">
      <h3 class="text-xl font-bold mb-2">Volumes Lógicos (Partições)</h3>
      <div v-for="disk in disks" :key="disk.name" class="mb-4">
