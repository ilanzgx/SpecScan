...
<template>
  <div class="p-4 space-y-6">
    ...
    <div v-if="adapters && adapters.length > 0" class="space-y-4">
      <h3 class="text-xl font-bold mb-4">Adaptadores Físicos</h3>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li><strong>MAC Address:</strong> <span class="font-mono text-xs">{{ adapter.mac_address }}</span></li>
    ...
    <div v-if="interfaces && interfaces.length > 0" class="space-y-4">
      <h3 class="text-xl font-bold mb-4">Interfaces de Tráfego Ativas</h3>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div
        ...
        >
          ...
          <ul class="space-y-2 text-sm">
            <li><strong>MAC Address:</strong> <span class="font-mono text-xs">{{ net.mac_address }}</span></li>
            <li>
